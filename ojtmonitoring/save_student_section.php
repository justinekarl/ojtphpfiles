...
foreach ($selCompIds as $key => $companyId) {
	...
	$insertSelectedCompanyQry = "INSERT INTO section(section_name,created_by_teacher_id) SELECT '$sectionName',$agentId WHERE '$sectionName' NOT IN (SELECT section_name FROM section) ";
	...
	error_log("insert section info ".print_r($result,true));	
